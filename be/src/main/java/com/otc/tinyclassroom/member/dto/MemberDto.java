...
public record MemberDto(String memberId, Set<ClassRoomDto> classRooms, String password, String name, String email, LocalDate birthday, int point) implements Serializable {
